...
{
    return swoole_model($model_name);
}
 ...
 * @throws \Swoole\Error
 */
function swoole_model($model_name, $db_key = 'master')
{
 ...
 */
function swoole_session($readonly = false)
{
 ...
 * @param $stop
 */
function swoole_error($error_id, $stop = true)
{
    global $php;
 ...
 */
//手动注释 Error：Cannot redeclare _string()
 ...
 */
//手动注释  Error：Cannot redeclare _array()
